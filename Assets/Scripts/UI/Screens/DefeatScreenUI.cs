...
//// Handles the basic defeat placeholder screen
...
//        bool shouldShow = GameStateManager.Instance.CurrentState == GameState.Defeat;
...
//        ClearSelectedUI();
//        Debug.Log("DefeatScreenUI: Returned to Main Menu placeholder.");
//    }
...
//        ClearSelectedUI();
//        Debug.Log("DefeatScreenUI: Restart placeholder.");
//    }
...
public class DefeatScreenUI : MonoBehaviour
{
    ...
    private void RefreshVisibility()
    {
        ...
        {
            screenFlowController.ShowDefeat();
        }
    }
    ...
    public void GoToMainMenu()
    {
        ...
        ClearSelectedUI();
        Debug.Log("DefeatScreenUI: Returned to Main Menu.");
    }
